            ...
            fiveDayForecast.DailyForecasts.map(forecast => {
                return (
                    <div className="daily-forecast">
                      ...
                      <img className="weather-icon fade-in" src={WEATHER_OPTIONS.find(i => forecast.Day.IconPhrase.toLowerCase().includes(i.title.toLowerCase())) ? WEATHER_OPTIONS.find(i => forecast.Day.IconPhrase.toLowerCase().includes(i.title.toLowerCase())).icon: ""} />
                    </div>
                )
            })}
        </div>
